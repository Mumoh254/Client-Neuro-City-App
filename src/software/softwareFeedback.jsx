...
const SoftwareFeedback = () => {
  ...
  const softwareInfo = {
    ...
    techStack: 'HTML  ,  CSS    ,  JAVASCRIPT , Email-js , Node-Mailer , React 19, Bootstrap-5,  OpenWeather API, TomTom, Leaflet Maps, Node.js, Google-Analytics, Prisma ORM, Index-DB ,  PostgreSQL on Neon DB, MONGO-DB , CLOUDINARY , SheetDB, GEO-Location , WEB SOCKETS ,  PWA-SUPPORT',
    description:
