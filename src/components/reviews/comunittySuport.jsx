    ...
    <Card className="shadow-lg border-0 rounded-3 my-5">
      <Card.Body className="p-5">
        <div className="text-center mb-5">
          <FaUserCircle className="text-secondary mb-3 text-danger " size="2rem" />
          <h1 className="display-5 fw-bold text-dark mb-2">
            Welcome back, {username}!
          </h1>
          <p className="lead text-muted">
            Nairobi's E-Jobs & E-Services Centre  - Create Jobs , See  open Positions .
          </p>
        </div>
        ...
        <div className="text-center mt-5">
          <p className="text-muted mb-0">
            Need help? Contact our online  community support ! Always Eager to Help <span className=" text-info ">welt tallis</span>
          </p>
        </div>
      </Card.Body>
    </Card>
